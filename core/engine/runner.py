...
from core.data.spread_schedule import cal_map_for, unique_spreads_from_cal, SpreadSchedule
...
from core.engine.signal_recorder import SignalRecorder, strategy_short_name
...
from core.portfolio.sizing import compute_vol_per_layer, ref_leg_close_from_df
...
def _maybe_build_sector_panel(
    ...
    if cfg.is_calendar_mode() and schedule is not None:
        from core.data.universe import resolve_products
